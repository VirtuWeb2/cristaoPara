  ...
  return (
    <div className="add">
      <div className="content">
        ...
        {preview2 && <img src={preview2} alt="" className="img-preview2" />}
...
//         previews.push(URL.createObjectURL(resizedImg));
//         resized.push(resizedImg);
//         done++;
...
//       const cover = urls[0] || "";
//       const imgContent = urls.length > 1 ? urls.slice(1) : [];

//       const payload = {
//         title: values.title,
//         cat: values.cat,
//         cover,
//         imgContent, // ✅ ARRAY REAL
//         desc: values.desc.replace(
//           /(<img\s+[^>]*src=")([^"]*)(")/g,
//           "$1$3"
//         ),
...
//       await axios.post(`${baseUrl}/post-news`, payload, {
//         headers: {
...
//         <button onClick={handleClick} className="app-content-headerButton">
//           Publicar notícia
//         </button>
//       </div>
...
//           {preview[0] && (
//             <img src={preview[0]} className="img-preview" alt="Capa" />
//           )}

//           <select
//             onChange={(e) => {
//               setMunicipios(regionesMunicipios[e.target.value]);
//               setValues({ ...values, reg: e.target.value });
//             }}
//           >
//             <option value="">Selecione a Região</option>
//             {Object.keys(regionesMunicipios).map((reg) => (
...
//           <select
//             onChange={(e) => {
//               setLinkMunicipio(municipioLinks[e.target.value]);
//               setValues({ ...values, muni: e.target.value });
//             }}
//           >
...
//           <div>
//             {["política", "segurança", "esportes", "foco"].map((c) => (
//               <label key={c}>
//                 <input
//                   type="radio"
//                   name="cat"
//                   value={c}
//                   onChange={(e) =>
//                     setValues({ ...values, cat: e.target.value })
//                   }
//                 />
//                 {c}
//               </label>
...
//         arrPreview.push(URL.createObjectURL(resized));
//         arrFile.push(resized);
//         processed++;

//         if (processed === files.length) {
//           setPreview(arrPreview);
//           setFile(arrFile);
//         }
//       });
//     });
...
//     const uploadPromises = file.map((img) => {
//       return new Promise((resolve, reject) => {
...
//               (snapshot.bytesTransferred / snapshot.totalBytes) * 100
//             );
//             toast.info(`Enviando imagem ${progress}%`);
//           },
//           reject,
//           async () => {
