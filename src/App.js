...
import WeatherForecast from "./components/clima/WeatherBoxSimple";
import Institucional from "./views/politicas/Institucional";
import Contato from "./views/politicas/Contato";
import "./App.css";
import FormAnuncio from "./views/politicas/Anuncie";
import AnuncioHeader from "./components/header/ad";
import Mensagens from "./views/politicas/mensagens";
import CarouselLinks from "./components/carrousellinks/linksEn";
