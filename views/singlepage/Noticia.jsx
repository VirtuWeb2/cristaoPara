...
const Noticia = () => {
  ...
  if (item) {
    ...
    console.log("item.imgContent:", item.imgContent);
    console.log("tipo imgContent:", typeof item.imgContent);
  }
}, [item]);

  const anexos =  Array.isArray(item?.imgContent)
      ? item.imgContent
    : [];
